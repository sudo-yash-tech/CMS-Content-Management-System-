...
@section('header')
  ...
  <!-- Header -->
  <header class="header text-white h-fullscreen pb-80" style="background-image: url(http://127.0.0.1:8000/storage/{{($post->image)}});" data-overlay="9">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            ...
            *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
            ...
            s.src = 'https://myash-1.disqus.com/embed.js';
